...
import type {
  ICAFItemsManager,
  ICAFItemsManagerInterface,
} from "../../../../contracts/core/interfaces/ICAFItemsManager";
...
export class ICAFItemsManager__factory {
  static readonly abi = _abi;
  static createInterface(): ICAFItemsManagerInterface {
    return new Interface(_abi) as ICAFItemsManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ICAFItemsManager {
    return new Contract(address, _abi, runner) as unknown as ICAFItemsManager;
  }
}
