...
export interface ICAFItemsManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface ICAFItemsManager extends BaseContract {
  connect(runner?: ContractRunner | null): ICAFItemsManager;
  waitForDeployment(): Promise<this>;

  interface: ICAFItemsManagerInterface;
