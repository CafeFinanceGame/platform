...
export interface CAFModuleBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface CAFModuleBase extends BaseContract {
  connect(runner?: ContractRunner | null): CAFModuleBase;
  waitForDeployment(): Promise<this>;

  interface: CAFModuleBaseInterface;
