...
export interface CAFAccessControlInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface CAFAccessControl extends BaseContract {
  connect(runner?: ContractRunner | null): CAFAccessControl;
  waitForDeployment(): Promise<this>;

  interface: CAFAccessControlInterface;
