...
export interface CAFGameManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface CAFGameManager extends BaseContract {
  connect(runner?: ContractRunner | null): CAFGameManager;
  waitForDeployment(): Promise<this>;

  interface: CAFGameManagerInterface;
