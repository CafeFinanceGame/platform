...
export interface CAFContractRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface CAFContractRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): CAFContractRegistry;
  waitForDeployment(): Promise<this>;

  interface: CAFContractRegistryInterface;
