...
export interface CAFTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface CAFToken extends BaseContract {
  connect(runner?: ContractRunner | null): CAFToken;
  waitForDeployment(): Promise<this>;

  interface: CAFTokenInterface;
