...
export const HeroSection: React.FC<Props> = () => {
        ...
        return (
            <div className="flex flex-col bg-white/15 rounded-3xl backdrop-blur-3xl w-fit max-w-lg overflow-hidden">
                ...
                <div className="flex flex-row gap-4 p-4 w-full">
                    <Image src="/assets/hero-card-1.png" className="w-32 aspect-square" alt="Business to earn" />
                    <p className="w-full break-words">
                        Build your coffee empire, trade resources, and earn <b>CAF Tokens</b> through strategic business growth
                    </p>
                </div>
                <div className="flex gap-4 justify-center items-center p-4 w-full bg-[#DEF821]">
                    <p className="text-[#A3B32B] font-semibold">
                        New game model - <span className="font-semibold">Business to earn</span>
                    </p>
                </div>
            </div>
        );
    ...
    const HeroCard2 = () => {
        return (
            <div className="flex flex-col bg-white/15 rounded-3xl backdrop-blur-3xl w-fit max-w-lg overflow-hidden">
                <h2 className="text-2xl font-bold text-white p-4">
                    Dynamic Player-Driven Economy                </h2>
                <div className="flex flex-row gap-4 p-4 w-full">
                    <Image src="/assets/hero-card-2.png" className="w-32 aspect-square" alt="Business to earn" />
                    <p className="w-full break-words">
                        A dynamic, player-driven economy where items decay, prices shift, events shape markets, and energy fuels strategic gameplay                    </p>
                </div>
    ...
    return (
        <section id="hero" className="relative w-full h-full flex flex-row justify-center items-start pt-16">
            <div className="flex flex-col justify-center gap-4 flex-1 text-default">
                <Chip color="primary" className="mb-4" radius="full" variant="bordered">CORE CHAIN</Chip>
                <h1 id="hero-title">
                    CaFi Game
                </h1>
                <p className="text-4xl font-bold text-foreground-500">Social PvP <span className="text-primary">Game</span></p>
